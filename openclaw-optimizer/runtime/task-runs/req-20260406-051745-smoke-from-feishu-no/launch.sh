...
jq -cn \
  ...
  '{finishedAt:$ts,exitCode:$exitCode,command:$cmd}' > /home/ubuntu/.openclaw/workspace/openclaw-optimizer/runtime/task-runs/req-20260406-051745-smoke-from-feishu-no/exit.json
exit "$exit_code"
