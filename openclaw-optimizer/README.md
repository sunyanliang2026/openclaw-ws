...
- `scripts/notify-task-completion.sh`: send task status updates (running/retrying/review/failed/completed/archived) back to Feishu (or configured channel target), and auto-attach task summary artifact on terminal/review statuses.
